...
const HomeScreen = () => {
    ...
    return (
        ...
        <View style={styles.container}>
            <Text style={styles.title}><Text style={{ color: colours.textColour }}>DO YOU KNOW WHAT I'M THINKING<Text/></Text><Text style={{ color: colours.primaryColour, fontSize: 40 }}>?</Text></Text>
